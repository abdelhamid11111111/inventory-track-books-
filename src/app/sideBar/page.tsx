  ...
  return (
    <div>
        ...
        <nav className="flex flex-col gap-2">
          <Link href='/' className="flex items-center gap-3 px-3 py-2 rounded-md hover:bg-gray-100 hover:text-gray-900 text-gray-600 font-medium" >
            <FaBook size={20}/>
            <span>Books Table</span>
          </Link>
          <Link href='search-filter' className="flex items-center gap-3 px-3 py-2 rounded-md text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium" >
            <IoSearch size={20}/>
            <span>Search</span>
          </Link>
          <Link href='/statistics' className="flex items-center gap-3 px-3 py-2 rounded-md text-gray-600 hover:bg-gray-100 hover:text-gray-900 font-medium" >
