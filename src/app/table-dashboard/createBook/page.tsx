                ...
                <label className="block">
                    ...
                    <div className="relative">
                      <select 
                            ...
                            value={book.category}
                            className="mt-1 block w-full rounded-md outline-none p-2.5 border border-gray-300 shadow-sm focus:border-[#137fec] focus:outline-none focus:ring-1 focus:ring-[#137fec] bg-white appearance-none cursor-pointer">
